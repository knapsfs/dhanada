...
export default function RiskComparison({ selectedFunds }) {
  ...
  const colors = [
    { border: '#7e22ce', bg: '#7e22ce', track: 'rgba(126, 34, 206, 0.1)' },
    { border: '#d97706', bg: '#d97706', track: 'rgba(217, 119, 6, 0.1)' },
    { border: '#78350f', bg: '#78350f', track: 'rgba(120, 53, 15, 0.1)' }
  ];
            ...
            <div key={index} className="bg-[#f7f9fc] rounded-xl p-3.5 sm:p-4 border border-[#e8edf7]">
              <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                ...
                <div className="inline-flex items-center gap-1.5 bg-white border border-[#e8edf7] px-2.5 py-0.5 rounded-lg shadow-sm">
                  ...
                  <span className="text-xs font-bold" >{riskLabel}</span>
                </div>
              </div>
              ...
              <div className="relative pt-1">
                ...
                {/* Scale markers */}
                <div className="flex justify-between text-[9px] sm:text-[10px] font-bold text-[#94a3b8] uppercase tracking-wider mt-2 px-0.5">
                  <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#16a34a]"></span>Level 1</span>
                  <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#84cc16]"></span>Level 2</span>
                  <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#eab308]"></span>Level 3</span>
                  <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#f97316]"></span>Level 4</span>
                  <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#ef4444]"></span>Level 5</span>
                </div>
              </div>
            </div>
          );

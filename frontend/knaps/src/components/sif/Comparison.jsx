              ...
              {comparisonData.rows.map((row, ri) => (
                <tr key={ri}
                  ...
                  {row.values.map((val, vi) => {
                    ...
                    return (
                      <td key={vi} className={`px-5 py-4 text-center ${isSIF ? 'bg-[#032e92]/5 border-x border-[#032e92]/10' : ''
                        }`}>
                        {val === 'Yes' ? (
                          ...
                          <span className={`text-sm font-semibold ${isSIF ? 'text-[#032e92]' : 'text-gray-600'
                            }`}>{val}</span>
                        )}
                      </td>
                    );

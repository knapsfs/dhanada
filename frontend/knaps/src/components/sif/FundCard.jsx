          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <Link to={`/sif/${encodeURIComponent(fund.id)}`} className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl border-2 border-[#e8edf7] text-gray-600 text-sm font-semibold hover:border-[#032e92] hover:text-[#032e92] transition-all duration-200">

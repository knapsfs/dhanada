          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-12">
            <div className="max-w-xl xl:max-w-2xl flex-1">
              ...
              <motion.p
                ...
                Maximize your wealth by increasing your SIP contributions over time. Calculate how stepping up your investments accelerates your journey towards financial goals.
              </motion.p>
            </div>

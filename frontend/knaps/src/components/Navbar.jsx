...
const navLinks = [
  ...
  // { label: 'AIF', href: '/#aif' },
  {
    ...
    href: '/services',
    dropdown: [
      { label: 'National Pension System (NPS)', href: '/nps' },
      { label: 'Small Savings Scheme', href: '/small-savings-schemes' },
      { label: 'Life Insurance', href: '/life-insurance' },
      { label: 'Health Insurance', href: '/health-insurance' },
      { label: 'General Insurance', href: '/general-insurance' },
      { label: 'ELSS Funds', href: '/elss' },
      { label: 'Fixed Deposits', href: '/fixed-deposits' },
      { label: 'Recurring Deposits', href: '/recurring-deposits' },

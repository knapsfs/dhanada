...
export default function SipHero() {
  return (
        ...
        <motion.div
          ...
          <div className="relative">
            ...
            <motion.p
              ...
              Estimate the future value of your monthly investments. Adjust your investment amount, expected return, and duration to seamlessly map out your wealth creation journey.
            </motion.p>

...
export default function FutureValueProjectionTable({ yearlyData }) {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center gap-2 px-6 py-5 border-b border-[#e8edf7]">
            ...
            <h2 className="text-lg font-bold text-gray-900">Yearly Investment Breakdown</h2>
          </div>
            ...
            <table className="w-full text-sm min-w-[620px]">
              <thead className="sticky top-0 z-10">
                <tr className="bg-[#f7f9fc] border-b border-[#e8edf7]">
                  {['Year', 'Invested Amount', 'Projected Value', 'Estimated Profit', 'Return %'].map(h => (
              ...
              <tbody className="divide-y divide-[#e8edf7]">
                {yearlyData.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 font-bold text-[#032e92]">{fmt(row.value)}</td>
                    <td className="px-5 py-3.5">

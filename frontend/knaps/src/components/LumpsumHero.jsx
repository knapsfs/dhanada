...
export default function LumpsumHero() {
  return (
        ...
        <motion.div
          ...
          <div className="relative">
            ...
            <motion.p
              ...
              Estimate the future value of your one-time investments. Discover the power of compounding on your lumpsum investments over time.
            </motion.p>

export function calculateRiskProfile(answers) {
	...
	let description =
		"Your responses indicate a stronger preference for stability and a lower tolerance for significant investment fluctuations.";

	if (totalScore > 60) {
		profile = "Very Aggressive";
		description =
			"Your responses indicate a high tolerance for significant market fluctuations and a strong preference for long-term growth potential.";
	} else if (totalScore > 50) {
		profile = "Aggressive";
		description =
			"Your responses indicate a relatively high comfort with substantial market fluctuations in pursuit of long-term growth potential.";
	} else if (totalScore > 38) {
		profile = "Moderately Aggressive";
		description =
			"Your responses indicate that you may be comfortable accepting a higher degree of market fluctuation in pursuit of long-term growth potential.";
	} else if (totalScore > 25) {
		profile = "Balanced";
		description =
			"Your responses indicate a preference for balancing growth potential with a meaningful level of stability.";
	}

...
export default function SipLumpsumHero() {
  return (
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-12">
            <div className="max-w-xl xl:max-w-2xl flex-1">
              ...
              <motion.p
                ...
                Calculate the compounding growth when combining an initial lump sum investment with ongoing monthly SIP contributions to reach your financial goals faster.
              </motion.p>
            </div>

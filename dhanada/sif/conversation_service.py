...
# Lead ID ke basis par CRM lead ka URL banata hai.
...
# Conversation document ko clean dictionary format me convert karta hai.
...
# Nayi persistent Chatbot Conversation create aur initialize karta hai.
...
# Conversation transcript me naya message add aur save karta hai.
def append_message(
	conversation_id: str,
	role: str,
	message: str,
...
# User ka message conversation transcript me append karta hai.
...
# AI assistant (Riddhi) ka message transcript me append karta hai.
...
# Conversation ka short summary ya context update karta hai.
...
# Conversation details aur complete transcript return karta hai.
...
# Associated CRM Lead ka URL generate karta hai.
...
# Lead aur contact details ko conversation ke sath link karta hai.
def associate_lead(
	conversation_id: str,

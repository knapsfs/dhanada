...
def execute():
	...
	try:
		...
		for perm in custom_docperms:
			frappe.delete_doc("Custom DocPerm", perm, ignore_permissions=True, force=True, ignore_missing=True)
	...
	if frappe.db.exists("User", "datascheduler@gmail.com"):
		try:
			frappe.delete_doc("User", "datascheduler@gmail.com", ignore_permissions=True, force=True, ignore_missing=True)
		except Exception as e:
	...
	if frappe.db.exists("Role Profile", "Data Scheduler"):
		try:
			frappe.delete_doc("Role Profile", "Data Scheduler", ignore_permissions=True, force=True, ignore_missing=True)
		except Exception as e:
	...
	if frappe.db.exists("Module Profile", "Data Scheduler"):
		try:
			frappe.delete_doc("Module Profile", "Data Scheduler", ignore_permissions=True, force=True, ignore_missing=True)
		except Exception as e:
	...
	if frappe.db.exists("Role", "Data Scheduler"):
		try:
			frappe.delete_doc("Role", "Data Scheduler", ignore_permissions=True, force=True, ignore_missing=True)
		except Exception as e:
